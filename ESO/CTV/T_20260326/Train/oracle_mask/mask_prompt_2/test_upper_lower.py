...
DEFAULT_OUTPUT_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/oracle_mask/mask_prompt_2/TestResult")
DEFAULT_MODEL_CFG = "configs/sam2.1/sam2.1_hiera_l.yaml"
DEFAULT_FINETUNED_CKPT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/oracle_mask/mask_prompt_2/TrainResult/fold_0/checkpoints/best.pth")
DEFAULT_TRAIN_OUTPUT_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/oracle_mask/mask_prompt_2/TrainResult")
...
@torch.no_grad()
def infer_with_two_prompt_slices(
    predictor,
    frame_dir: Path,
    gt_zyx: np.ndarray,
    lower_id: int,
...
def main():
    parser = argparse.ArgumentParser("Test SAM2 with upper/lower mask prompts")
    ...
    parser.add_argument("--excel-name", type=str, default="prompt_layer_search2.xlsx")
    ...
    for pdir in patient_dirs:
        ...
        print(f"[INFO] {patient_id} | fixed prompts: upper={upper_id}, lower={lower_id}")

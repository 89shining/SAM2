...
class SAM2TrainUpperLowerMask(SAM2Train):
    ...
    def prepare_prompt_inputs(self, backbone_out, input, start_frame_idx=0):
        ...
        for obj_idx in range(o_dim):
            ...
            if pos_t.numel() == 0:
                # Robust fallback for empty-object samples.
                lower = start_frame_idx
                upper = start_frame_idx
            else:
        ...
        for t in init_cond_frames:
            ...
            for o in range(o_dim):
                if lower_ids[o] == t or upper_ids[o] == t:
                    prompt_t[o] = gt_t[o]

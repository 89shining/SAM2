...
@torch.no_grad()
def infer_two_stage_iterative_with_oracle_middle(
    predictor,
    frame_dir: Path,
    gt_zyx: np.ndarray,
    lower_id: int,
...
def main():
    ...
    parser.add_argument("--prompt3-xlsx", type=Path, required=True, help="mask_prompt_3 output excel with Best_Prompt_Slice_ID")
    ...
    for pdir in patient_dirs:
        ...
        try:
            ...
            pred_stage1, pred_stage2 = infer_two_stage_iterative_with_oracle_middle(
                predictor=predictor,
                frame_dir=tmp_dir,
                gt_zyx=gt_zyx,
                lower_id=lower_id,

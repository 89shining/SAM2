...
def main():
    parser = argparse.ArgumentParser(
        description="Run training then testing in iterative mode with selector-pass1 and main-model pass2."
    )
    parser.add_argument("--gpu", type=str, default="6", help="CUDA_VISIBLE_DEVICES value")

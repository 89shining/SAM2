...
OUT_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/zero-shot/oracle_mask/mask_prompt_k2_to_k10")

# You can override via env ORACLE_XLSX
ORACLE_XLSX = Path(
    os.environ.get(
        "ORACLE_XLSX",
        r"C:\Users\dell\Desktop\Eso-CTV\AAPM投稿\Optimal_mask\Oracle_Summary.xlsx",
    )
)

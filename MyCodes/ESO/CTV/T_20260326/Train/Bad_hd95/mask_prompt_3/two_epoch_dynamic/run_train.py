...
DEFAULT_EXP_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/BadHD95_slice/mask_prompt_3/two_epoch_dynamic")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run bad_hd95 two-epoch iterative training then testing (auto-resume enabled)."
    )
    ...
    parser.add_argument(
        ...
        help="External 2-prompts TrainResults root used for model initialization in train.py.",
    )

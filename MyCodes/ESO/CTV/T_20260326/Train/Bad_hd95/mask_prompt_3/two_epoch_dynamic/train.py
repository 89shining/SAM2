...
DEFAULT_OUTPUT_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/BadHD95_slice/mask_prompt_3/two_epoch_dynamic/TrainResult")
DEFAULT_MODEL_CFG = "configs/sam2.1/sam2.1_hiera_l.yaml"
DEFAULT_INIT_TRAIN_OUTPUT_ROOT = Path("XXXX")
...
def main():
    parser = argparse.ArgumentParser("SAM2 upper/lower -> online bad_95 middle iterative mask finetuning")

...
Example:
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 train_upper_lower_middle_cv_one_epoch.py
"""
...
DEFAULT_OUTPUT_ROOT = Path("/home/wusi/SAM2/SAM2data/Eso/20260326/Train/oracle_mask/mask_prompt_3/one_epoch/TrainResult")
...
def main():
    parser = argparse.ArgumentParser("SAM2 upper/lower/middle-mask prompt finetuning (one_epoch default)")

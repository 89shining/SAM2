...
from io_utils import DEFAULT_INIT_CKPT, DEFAULT_MODEL_CFG, default_result_base
...
def main():
    ...
    parser.add_argument("--train-models", type=str, default="2-4")
    ...
    if not args.no_test:
        ...
        rename_outputs_to_gtvp(default_result_base(GTVP_ALIAS_ROOT))

...
for kind in ('pos','neg'):
    run([PY,CODE/'select_branch_gaussian_validation.py','--kind',kind,'--data-root',DATA,
         '--split-json',a.run_root/'checkpoints'/kind/'s01mm'/'split.json',
...
fusion=CODE.parent/'fusion_test'/'run_gaussian_fusion_test.py'

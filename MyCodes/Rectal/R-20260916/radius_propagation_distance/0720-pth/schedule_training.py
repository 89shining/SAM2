...
CODE = Path("/home/wusi/SAM2/MyTrain/MyCodes/Rectal/R-20260916")
RUN = Path("/home/wusi/SAM2/MyTrain/SAM2data/Rectal/R-20260916")
DATA = RUN / "Prompt_mask"
SOURCE_SPLIT = Path("/home/wusi/SAM2/MyTrain/SAM2data/Rectal/R-20260720/TrainResults/POS/split.json")
POS_WARM_START = Path("/home/wusi/SAM2/MyTrain/SAM2data/Rectal/R-20260720/TrainResults/POS/checkpoints/best.pth")
NEG_WARM_START = Path("/home/wusi/SAM2/MyTrain/SAM2data/Rectal/R-20260720/TrainResults/NEG/checkpoints/best.pth")
...
def command(branch: str, radius: int, output: Path) -> list[str]:
    ...
    result = [
        ...
        "--skip-test",
        "--warm-start", str(POS_WARM_START if branch == "pos" else NEG_WARM_START),
    ]
    if branch == "pos":
